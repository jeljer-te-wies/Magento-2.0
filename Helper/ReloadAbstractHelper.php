...
class ReloadAbstractHelper extends AbstractHelper
{
    ...
    public function collectStores()
    {
        ...
        foreach($this->_storeManager->getWebsites() as $website)
        {
            ...
            foreach($website->getStores() as $store)
            {
                ...
                {
                    $frontendBaseUrl = $this->_storeManager->getStore($store->getStoreId())->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_LINK, array('_secure' => true));
                }
                else
                {
                    $frontendBaseUrl = $this->_storeManager->getStore($store->getStoreId())->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_LINK);
                }
